...
public class WhenCreatingTheAccount
{
    ...
    public async Task ThenIShouldGetBackTheNewAccountId()
    {
        ...
        //Assert
        response.Data?.EmployerAgreement?.HashedAccountId.Should().Be(hashedId);
    ...
    public void ThenTheSummaryViewRetrievesCookieData()
    {
        ...
        //Assert
        model.Data.OrganisationName.Should().Be(employerAccountData.EmployerAccountOrganisationData.OrganisationName);
        model.Data.OrganisationStatus.Should().Be(employerAccountData.EmployerAccountOrganisationData.OrganisationStatus);
        model.Data.OrganisationReferenceNumber.Should().Be(employerAccountData.EmployerAccountOrganisationData.OrganisationReferenceNumber);
        model.Data.PayeReference.Should().Be(employerAccountData.EmployerAccountPayeRefData.PayeReference);
        model.Data.EmployerRefName.Should().Be(employerAccountData.EmployerAccountPayeRefData.EmployerRefName);
        model.Data.EmpRefNotFound.Should().Be(employerAccountData.EmployerAccountPayeRefData.EmpRefNotFound);
