...
public class WhenRenamingAnAccount
{
        ...
        EmployerAccountOrchestrator orchestrator)
    {
        ...
        response.Data.ErrorDictionary["NewName"].Should().Be("Account Name must only include letters a to z, numbers 0 to 9, and special characters such as hyphens, spaces and apostrophes");
    }
        ...
        EmployerAccountOrchestrator orchestrator)
    {
        ...
        //Assert
        response.Data.ErrorDictionary.Count().Should().Be(1);
        response.Data.ErrorDictionary["NewName"].Should().Be("Enter a name");
    }
}