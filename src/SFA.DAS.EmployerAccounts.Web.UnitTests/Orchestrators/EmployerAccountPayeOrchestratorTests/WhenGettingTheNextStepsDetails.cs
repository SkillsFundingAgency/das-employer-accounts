...
public class WhenGettingTheNextStepsDetails
{
        ...
        EmployerAccountPayeOrchestrator orchestrator)
    {
        ...
        //Assert
        actual.Should().BeAssignableTo<OrchestratorResponse<PayeSchemeNextStepsViewModel>>();
        actual.Should().NotBeNull();
        actual.Data.ShowWizard.Should().BeTrue();
        ...
        EmployerAccountPayeOrchestrator orchestrator)
    {
        ...
        //Assert
        actual.Should().NotBeNull();
        actual.Data.ShowWizard.Should().BeFalse();
    }
}